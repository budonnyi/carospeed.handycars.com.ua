...
Chart.elements.Rectangle.prototype.draw = function() {
    ...
    var cornerPosition = this._chart.config.options.cornerposition;
    ...
    for (var i = 1; i < 4; i++) {
        ...
        if(height < 0){
            ...
            if(cornerPosition){
                ...
                if(cornerPosition == 'right' || cornerPosition == 'top' || cornerPosition == 'all'){
                ...
                if(cornerPosition == 'right' || cornerPosition == 'bottom' || cornerPosition == 'all'){
                ...
                if(cornerPosition == 'left' || cornerPosition == 'bottom' || cornerPosition == 'all'){
                ...
                if(cornerPosition == 'left' || cornerPosition == 'top' || cornerPosition == 'all'){
